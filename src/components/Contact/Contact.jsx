    ...
    return (
        <div className='contact' id='contact'>
            ...
            <div className='contact-reachout-container'>
                <button data-aos='fade-right' onClick={() => window.open('https://www.linkedin.com/in/sarthakjain248/', '_blank')}> 
                    <img 
                    className='linkedin-title-image' src={require('../../images/linkedinTitleImage.png')} alt="image" /> 
                </button>
                <button data-aos='fade-left' onClick={() => window.open('https://github.com/sarthak248', '_blank')}> 
